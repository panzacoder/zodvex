...
const labelText = z.string();
const commentText = z.string();
...
const models = {
  ...
  table05: defineZodModel('table05', {
    ...
    note: commentText.optional(),
    detail: z.object({
      grouping: z.object({ name: labelText, alias: z.string().optional(), note: z.string().nullable() }).strict().optional(),
      active,
      remark: commentText.optional(),
    }),
  ...
  table09: defineZodModel('table09', {
    ...
    note: commentText.optional(),
    detail: z.object({
      grouping: z.object({ name: labelText, alias: z.string().optional(), note: z.string().nullable() }).optional(),
