...
graph TD
    ...
    subgraph "Fail-Secure Modes"
        ...
        F1 -->|"mode: 'open'"| F2["Return raw value<br/>❌ Dangerous"]
        F1 -->|"mode: 'closed'"| F3["Auto-redact<br/>✅ Safe"]
        F1 -->|"mode: 'throw'"| F4["Throw error<br/>✅ Safe but disruptive"]
        F1 -->|"mode: 'warn'"| F5["Log + return raw<br/>⚠️ Moderate"]
    end
    ...
    subgraph "Detection Flow: applyReadPolicy()"
        ...
        D4 -->|"Yes"| D5["✅ Process normally"]
        D4 -->|"No"| D6["⚠️ Orphaned fields<br/>detected!"]
        D6 --> F1
    end
    ...
    subgraph "Example: The Vulnerability"
        ...
        E3 --> E4["Detection compares:<br/>- Data has __sensitiveValue ✓<br/>- Schema has no marker ✗"]
        E4 --> E5["🚨 ORPHAN DETECTED"]
    end
