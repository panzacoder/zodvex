...
describe('codegen e2e', () => {
  it('full pipeline: discover → generate → write → verify', async () => {
    ...
    expect(clientContent).toContain('createReactClient')
    expect(clientContent).toContain('encodeArgs')
    expect(clientContent).toContain('decodeResult')
  ...
  it('client.ts imports from zodvex/react, zodvex/client, zodvex/core, and ./api', () => {
    const clientContent = generateClientFile()
    expect(clientContent).toContain("from 'zodvex/react'")
    expect(clientContent).toContain("from 'zodvex/client'")
    expect(clientContent).toContain("from 'zodvex/core'")
